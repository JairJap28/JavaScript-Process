...
//If there is any text inside item field, add that text to the to-do list
...
//Put the item in the complete items list
function completItem(){
    var item = this.parentNode.parentNode;
    var parent = item.parentNode;
    var id = parent.id;

    //Check if the item should be added to completed list or re-added to the to-do list
...
function addItemTodo(text){
    ...
    //Add click for completing the item
    complete.addEventListener('click', completItem);
